...
package com.hufeiya.SignIn.widget;
...
import com.hufeiya.SignIn.helper.ViewUtils;
...
public class TextResizeTransition extends Transition {
    ...
    private static final String PROPERTY_NAME_TEXT_RESIZE =
            "com.hufeiya.SignIn.widget:TextResizeTransition:textSize";
    private static final String PROPERTY_NAME_PADDING_RESIZE =
            "com.hufeiya.SignIn.widget:TextResizeTransition:paddingStart";
